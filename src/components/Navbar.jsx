...
function Navbar() {
    ...
    return (
        <nav className="py-3 px-4 w-full bg-slate-950">
                ...
                <div className="hidden md:flex gap-5">
                    {navItems.map((item) => (
                        <NavLink
                            ...
                            to={item.path}
                            className={({ isActive }) =>
                                `py-2 px-3 rounded-[10px] w-full  ${isActive
            ...
            {/* Mobile Navbar */}
            <div
                className={`md:hidden absolute top-0 p-5 flex flex-col gap-5 h-full w-[80%] bg-slate-950 ${isOpen ? "left-0" : "-left-full"}`}
            >
                ...
                <div className="flex flex-col">
                    {navItems.map((item) => (
                        <NavLink
                            ...
                            to={item.path}
                            className={({ isActive }) =>
                                `p-2 rounded-[10px] w-full  ${isActive
                                    ? "bg-green-600 text-slate-100"
                                    : "text-slate-100 hover:bg-green-950 transition-colors duration-300"
                                }`
                            }
